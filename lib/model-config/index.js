...
//     "network": { "allowedHosts": ["api.example.com"], "methods": ["POST"], "defaultTimeoutMs": 30000 }
//   }
//   自定义 API 仍受 manifest.network.allowedHosts 约束；使用名单外域名时，
//   先把域名加入插件目录的 manifest.json，再重启 HanaAgent。不要写 ["*"]，宿主按主机名白名单校验。
